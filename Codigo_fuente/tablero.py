...
class Game(object):
    ...
    def get_value(self,casilla_actual,casilla,tipo,player,value1,value2,respuesta,DADO1,DADO2):
    ...
    def run_logic(self,screen,jugador,dados,casilla,turnos,cant_jugadores):
        ...
        if self.cont == 1:
            ...
            Newvalue = self.get_value(casilla[indice],casilla,casilla[indice].tipo,jugador[self.Turno_actual], value1, value2,a_value,DADO1,DADO2)
            Newvalue -= 1
